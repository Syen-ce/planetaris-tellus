...
function Wasprunanimation(scale)
  return
  {
    layers=
    {
      util.sprite_load("__planetaris-tellus__/graphics/entity/wasp/wasp-fly",
        {
          slice = 8,
          frame_count = 16,
          direction_count = 16,
...
function waspattackanimation(scale)
  return
  {
    layers=
    {
      util.sprite_load("__planetaris-tellus__/graphics/entity/wasp/wasp-attack",
        {
          slice = 8,
          frame_count = 8,
          direction_count = 16,
...
function waspdieanimation(scale)
  return
  {
    layers=
    {
      util.sprite_load("__planetaris-tellus__/graphics/entity/wasp/wasp-die",
        {
          slice = 8,
          frame_count = 16,
          direction_count = 16,
...
function wasp_decay_animation(scale, tint1, tint2)
  return
  {
    layers=
    {
...
function add_wasp_die_animation(scale, corpse)
  corpse.animation = waspdieanimation(scale, tint1, tint2)
  corpse.decay_animation = wasp_decay_animation(scale, tint1, tint2)
